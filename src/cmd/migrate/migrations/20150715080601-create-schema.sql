...
CREATE TABLE `identifiers` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `docset_name` varchar(340) COLLATE utf8mb4_unicode_ci NOT NULL,
  `docset_filename` varchar(340) COLLATE utf8mb4_unicode_ci NOT NULL,
  `docset_platform` varchar(340) COLLATE utf8mb4_unicode_ci NOT NULL,
  `docset_bundle` varchar(340) COLLATE utf8mb4_unicode_ci NOT NULL,
  `docset_version` varchar(340) COLLATE utf8mb4_unicode_ci NOT NULL,
  `page_path` longtext COLLATE utf8mb4_unicode_ci NOT NULL,
  `page_title` varchar(340) COLLATE utf8mb4_unicode_ci NOT NULL,
  `httrack_source` longtext COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `entries` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `title` varchar(340) COLLATE utf8mb4_unicode_ci NOT NULL,
  `body` longtext COLLATE utf8mb4_unicode_ci NOT NULL,
  `body_rendered` longtext COLLATE utf8mb4_unicode_ci NOT NULL,
  `type` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `identifier_id` int(10) unsigned NOT NULL,
  `anchor` varchar(2000) COLLATE utf8mb4_unicode_ci NOT NULL,
